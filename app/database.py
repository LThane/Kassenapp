...
def seed_test_data():
    # Populate a brand-new database with a few members and sample costs.
    with db_session() as session:
        ...
        members_data = [
            {"name": "Alex Example", "email": "alex@example.com", "password": "password123"},
            {"name": "Jamie Sample", "email": "jamie@example.com", "password": "secret456"},
            {"name": "Taylor Demo", "email": "taylor@example.com", "password": "demo789"},
        ]
        ...
        for cost_data in costs_data:
            ...
            cost = Cost(
                ...
                date=(today - timedelta(days=cost_data["days_ago"])).strftime("%Y-%m-%d"),
