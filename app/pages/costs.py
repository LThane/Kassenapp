        ...
        rx.el.form(
            rx.el.div(
                ...
                rx.el.select(
                    ...
                    class_name="mt-1 block w-full px-3 py-2 bg-white border border-gray-300 rounded-md text-sm shadow-sm focus:outline-none focus:ring-violet-500 focus:border-violet-500",
                ),
